#!/bin/bash
# ======================================================
# 🧬 SnpEff pipeline completo para análisis de EVOL1
...
SNPEFF_PATH=~/snpEff                    # Usa la instalación local personalizada
GENOME_NAME=mi_ref
...
INPUT_VCF=$BASE_DIR/variantes/evol1/evol1_filtrado.vcf.gz

# Carpeta donde guardar los resultados
RESULTS_DIR=$BASE_DIR/resultados_snpeff/evol1
mkdir -p "$RESULTS_DIR"

# Archivos de salida
OUTPUT_VCF=$RESULTS_DIR/evol1_snpeff.ann.vcf
REPORT_HTML=$RESULTS_DIR/evol1_snpeff_report.html
LOG_FILE=$RESULTS_DIR/snpeff_evol1.log
...
cp "$BASE_DIR/prokka_resultados_general/anc_prokka_general.gff" "$SNPEFF_PATH/data/$GENOME_NAME/genes.gff"
...
cp "$FASTA" "$SNPEFF_PATH/data/$GENOME_NAME/sequences.fa"
...
# ==== 6. FINALIZAR ====
echo "✅ Análisis de EVOL1 completado."
echo "Resultados:"
